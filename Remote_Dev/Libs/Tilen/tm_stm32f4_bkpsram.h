 ...
 */
#define TM_BKPSRAM_Write8(address, value)	(*(volatile uint8_t *) (BKPSRAM_BASE + (address)) = (value))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_Read8(address)			(*(volatile uint8_t *) (BKPSRAM_BASE + address))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_Write16(address, value)	(*(volatile uint16_t *) (BKPSRAM_BASE + (address)) = (value))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_Read16(address)			(*(volatile uint16_t *) (BKPSRAM_BASE + address))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_Write32(address, value)	(*(volatile uint32_t *) (BKPSRAM_BASE + (address)) = (value))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_Read32(address)			(*(volatile uint32_t *) (BKPSRAM_BASE + address))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_WriteFloat(address, value)	(*(volatile float *) (BKPSRAM_BASE + (address)) = (value))
 ...
 * @note   Defined as macro for faster execution
 */
#define TM_BKPSRAM_ReadFloat(address)			(*(volatile float *) (BKPSRAM_BASE + address))
